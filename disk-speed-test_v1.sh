...
echo -e "Target Dir : ${CYAN}$TARGET_DIR${NC}"
echo -e "Test Size  : ${CYAN}$TEST_SIZE${NC} ($((TOTAL_BYTES / 1024 / 1024)) MB)"
echo -e "Block Size : ${CYAN}$BLOCK_SIZE${NC}"
echo -e "Blocks     : ${CYAN}$COUNT${NC}"
echo -e "Mode       : ${CYAN}$( [ "$USE_DSYNC" = true ] && echo "Accurate (dsync)" || echo "Fast (cached)" )${NC}"
...
echo -e "${CYAN}Test completed safely. Temp file deleted.${NC}"
